...
import com.example.noteapp.Model.CreateNoteViewModel
import com.example.noteapp.R
import com.example.noteapp.databinding.ActivityCreateNoteFragmentBinding
import com.example.noteapp.util.extension.EMPTY_STRING
...
class CreateNoteFragment :
    Fragment(R.layout.activity_create_note_fragment),
    EasyPermissions.PermissionCallbacks,
    EasyPermissions.RationaleCallbacks {

    private val binding by viewBinding(ActivityCreateNoteFragmentBinding::bind)
    ...
    private val broadcastReceiver: BroadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(p0: Context?, p1: Intent?) {
            ...
            view?.let { fragmentView ->
                val binding = ActivityCreateNoteFragmentBinding.bind(fragmentView)
